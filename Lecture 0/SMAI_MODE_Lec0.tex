...
\begin{itemize}
    ...
    \item[1.] Motivations, and a full (simple) example \hfill ($\sim$ 45 mins)
    \item[2.] Missing details: interpolation, semidefinite programming and duality \hfill ($\sim$ 60 mins)
    \item[3.] Hands-on notebook examples and Q\&A \hfill ($\sim$ 60 mins)
    \item[4.] Compact convergence \& non-convergence certificates \hfill ($\sim$ 60 mins)
    \begin{itemize}
        \item Using PEPs to search for cycles (no convergence).
        \item Using PEPs to search for Lyapunov functions (convergence).
    \end{itemize}
    \item[5.] Hands-on notebook examples and Q\&A \hfill ($\sim$ 60 mins)
